...
;~    EndIf
	...
	;~  #forceref $oErrorHandler
	Local $xmlFileName = $Array[$index][1]&"_"&@YEAR&@MON&@MDAY
...
;~ 	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","SeqNo","","关检关联号")
	...
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","AgentCodeScc","91510116MA6BQ5PB2B","报关申报单位社会信用代码")
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","AgentCode","5100310175","报关申报单位代码")
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","AgentName","和越国际货运代理（成都）有限公司","报关申报单位名称")
...
;~ 	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","Risk","","上海EDI报关单：最后10位用于存放风险评估参数RISK。")
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","CopCodeScc","91510116MA6BQ5PB2B","企业内部社会信用代码")
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","CopCode","5100310175","企业内部编号")
	_XML_MakeNode($oXmlDoc, "DecMessage/DecHead","CopName","和越国际货运代理（成都）有限公司","企业内部名称")
...
;~ 	_XML_MakeNode($oXmlDoc, "DecMessage/DecGoodsLimits/DecGoodsLimit/DecGoodsLimitVin","PricePerUnit","","")
	...
	_XML_MakeNode($oXmlDoc, "DecMessage/DecSign","CopCode","5100310175","操作员所属企业组织机构代码")
...
;~     _XML_MakeNode($oXmlDoc, "DecMessage","EdocRealation","","电子随附单据关联关系信息")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocID","","文件名、随附单据编号（命名规则是：申报口岸+随附单据类别代码+IM+18位流水号）	")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocCode","1","随附单证类别")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocFomatType","US","随附单据格式类型")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","OpNote","","操作说明（重传原因）")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocCopId","","随附单据文件企业名")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocOwnerCode","","所属单位海关编号")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","SignUnit","","签名单位代码")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","SignTime","","签名时间")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocOwnerName","","所属单位名称")
;~     _XML_MakeNode($oXmlDoc, "DecMessage/EdocRealation","EdocSize","","随附单据文件大小")
...
;~    MsgBox(0,"",_XML_TIDY($oXmlDoc))
   _XML_LoadXML($oXmlDoc,_XML_TIDY($oXmlDoc))
	...
	FileClose($hFileOpen)
	$sFileRead = StringReplace($sFileRead,' xmlns=""',"")
...
;~ 	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","BondInvtNo","","保税清单编号");海关审批通过后系统自动返填
	...
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","DclEtpsSccd","91510116MA6BQ5PB2B","申报企业社会信用代码")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","DclEtpsno","5100310175","申报企业编号")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","DclEtpsNm","和越国际货运代理（成都）有限公司","申报企业名称")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","InputCreditCode","91510116MA6BQ5PB2B","录入单位社会信用代码")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","InputCode","5100310175","录入单位代码")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","InputName","和越国际货运代理（成都）有限公司","录入单位名称")
...
;~ 	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","EntryNo","","对应报关单编号")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","CorrEntryDclEtpsSccd","91510116MA6BQ5PB2B","对应报关单申报单位社会统一信用代码")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","CorrEntryDclEtpsNo","5100310175","对应报关单申报单位代码")
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtHeadType","CorrEntryDclEtpsNm","和越国际货运代理（成都）有限公司","对应报关单申报单位名称")
...
;~ 	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","DecSeqNo","","报关单统一编号")
	...
	_XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","DclEtpsSccd","91510116MA6BQ5PB2B","申报企业社会信用代码")
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","DclEtpsno","5100310175","申报企业编号")
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","DclEtpsNm","和越国际货运代理（成都）有限公司","申报企业名称")
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","InputCreditCode","91510116MA6BQ5PB2B","录入单位社会信用代码")
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","InputCode","5100310175","录入单位代码")
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage/InvtDecHeadType","InputName","和越国际货运代理（成都）有限公司","申报企业名称")
...
;~ Z7---海关特殊监管区域管理系统
;~ Z8---保税物流管理系统
    _XML_MakeNode($oXmlDoc, "Signature/Object/Package/DataInfo/BussinessData/InvtMessage","OperCusRegCode","5100310175","操作卡的海关十位")
...
;~ 	_XML_Tidy($oXmlDoc)
	...
	$sFileRead = StringReplace($sFileRead,"{+}","+")
    Local $hFileOpen = FileOpen($xmlFullPath,2)
 	If StringLeft($sFileRead,5) <> "<?xml" Then $sFileRead = '<?xml version = "1.0" encoding = "utf-8"?>' & @CRLF & $sFileRead
	FileWrite($hFileOpen,$sFileRead)
	FileClose($hFileOpen)
...
Func zgGetSeqNo($sFileName,$xmlItem)
	...
	FileClose($hFileOpen)
	$sFileRead = StringReplace($sFileRead," xmlns="," xmlns:ns2 = ")
